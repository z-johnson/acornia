...
export const FOLK = {
  ...
  Redpelt:{tag:"Fierce Children of the Old Groves",emoji:"🦊",mod:{agility:1,wits:-1},
    ...
    ],bonusSkills:["Climb / Leap","Sprint / Flee"]},
  Shadowtail:{tag:"Born from Moonlit Canopies",emoji:"🖤",mod:{cunning:1,presence:-1},
    ...
    ],bonusSkills:["Stealth / Hide","Deceive / Bluff","Sleight of Hand"]},
  Glideborn:{tag:"Those Who Touch the Sky",emoji:"🪂",mod:{agility:1,brawn:-1},
    ...
    ],bonusSkills:["Glide (airborne)","Shoot (ranged)"]},
  Palewhisker:{tag:"The Touched Ones, Marked by Fate",emoji:"🤍",mod:{insight:2,brawn:-1},
    ...
    ],bonusSkills:["Ritual / Cast","Spirit Commune","Foresee (portents)"]},
};

export const CLASSES = {
  "Oakshield Warrior":{tag:"Iron Will, Acorn-Hard",icon:"⚔️",coreAttr:"brawn",hpBase:6,hpPerLevel:3,bonusSkill:"Strike (melee)",
  ...
  "Briar Rogue":{tag:"Quick Paws, Quiet Shadows",icon:"🗡️",coreAttr:"cunning",hpBase:4,hpPerLevel:2,bonusSkill:"Stealth / Hide",
  ...
  "Grove Shaman":{tag:"Keeper of Root and Sky",icon:"🌿",coreAttr:"insight",hpBase:3,hpPerLevel:2,bonusSkill:"Ritual / Cast",
  ...
  "Canopy Ranger":{tag:"Eyes of the High Branches",icon:"🏹",coreAttr:"agility",hpBase:5,hpPerLevel:2,bonusSkill:"Shoot (ranged)",
  ...
  "Gilded Herald":{tag:"Voice that Moves Mountains",icon:"📯",coreAttr:"presence",hpBase:4,hpPerLevel:2,bonusSkill:"Persuade / Charm",
...
export const SKILL_EXAMPLES = {
  "Strike (melee)":"Attacking an enemy at close range with claws, a club, or a blade",
  "Shove / Grapple":"Pushing a guard off a ledge or pinning an enemy so an ally can escape",
  "Endure (fatigue & saves)":"Shaking off a poison, resisting exhaustion after a long chase, or recovering from a stun",
  "Break / Force (obstacles)":"Smashing open a barricaded door or bending iron bars blocking a passage",
  "Throw":"Hurling a rock at a distant enemy or tossing a rope across a gap to a trapped ally",
  "Shoot (ranged)":"Firing a sling or bow at an enemy across the room or up in the canopy",
  "Climb / Leap":"Scaling a crumbling bark wall, leaping between branches, or grabbing a ledge mid-fall",
  "Dodge / Evade":"Diving out of the way of a swooping owl attack or rolling clear of a falling branch",
  "Sprint / Flee":"Racing across rooftops to outrun pursuing Baron enforcers",
  "Glide (airborne)":"Steering your glide-cloak through a narrow canyon or riding a thermal to gain height",
  "Balance / Tumble":"Running across a slippery rain-soaked branch or rolling safely through a bad landing",
  "Spot / Listen":"Noticing an ambush before it springs, or overhearing a whispered conversation in a crowded inn",
  "React (initiative)":"Acting first when a tense negotiation suddenly erupts into violence",
  "Navigate / Track":"Following a trail through the Elder Grove or finding your way back to camp in the dark",
  "Recall (lore & knowledge)":"Remembering a faction's history, a creature's weaknesses, or a location's secrets",
  "Read Situation (tactics)":"Spotting the best position in a chaotic fight or identifying the enemy's weak point before acting",
  "Ritual / Cast":"Performing a nature ritual to request aid from the spirits of the grove",
  "Nature Sense":"Reading the health of a forest or sensing whether a grove has been corrupted by the Hollow",
  "Read Person (motives)":"Figuring out if an NPC is lying, what they really want, or whether they can be trusted",
  "Spirit Commune":"Speaking with an ancestor spirit or asking a bound creature a question it must answer honestly",
  "Foresee (portents)":"Interpreting signs and omens to get a hint of what danger lies just ahead",
  "Persuade / Charm":"Talking your way past a suspicious gate-guard or convincing a merchant to lower their price",
  "Intimidate":"Staring down a rival gang or making a captured enemy give up information without a fight",
  "Rally / Inspire allies":"Pulling a frightened ally back into the fight with a well-timed word during a desperate moment",
  "Perform / Entertain":"Putting on a show to distract a crowd of guards while your allies sneak past",
  "Command (give orders)":"Coordinating your party in a chaotic battle or directing frightened NPCs in a crisis",
  "Stealth / Hide":"Slipping past a patrol in the dark or disappearing into a crowded marketplace",
  "Lockpick / Disarm trap":"Opening a locked strongbox or disabling a spring-loaded thorn-snare before it fires",
  "Craft / Tinker":"Jury-rigging a broken rope bridge or improvising a tool from scraps found in an alley",
  "Set Trap":"Laying a tripwire along the enemy's patrol route before they arrive",
  "Sleight of Hand":"Palming a key from a guard's belt or planting a forged letter in a noble's coat",
  "Deceive / Bluff":"Posing as a tax collector to get inside the Baron's counting house",
};
